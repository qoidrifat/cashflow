...
| Audit sistem 21 Juni 2026 | `docs/audit/CASHFLOW_SYSTEM_AUDIT_REPORT.md` | ⚠️ **Usang sebagian** — mendeskripsikan "Supabase Auth + RLS properly implemented" dan "Gmail Sync memakai provider_token dari session Supabase" padahal stack kini Better Auth + Turso |
...
| 4 | `CASHFLOW_SYSTEM_AUDIT_REPORT.md` snapshot usang (21 Juni) | Medium | `docs/audit/` |
