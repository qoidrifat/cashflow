...
| Session management | ✅ | Session-expiry dialog | middleware `req.user` | `session` | — | — | — | E2E | README |
...
| Review → external channels | ✅ | — | webhook + SMTP (`GMAIL_WEBHOOK_URL`, `SMTP_*`) | — | — | — | — | unit | README |
...
| Notifications (in-app) | ✅ | Bell dropdown | `/api/notifications*` | `notifications` | — | SSE push | — | `notifications-realtime.spec.ts` | docs/e2e |
...
| Alert rules + channels | ✅ | Admin alerts | scheduler + webhook/SMTP | `alert_rules` | — | — | ✅ | unit | README |
