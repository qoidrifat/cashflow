    ...
    >
      <Card className="relative overflow-hidden">
        ...
        <button
          ...
          className="absolute top-3 right-3 p-1 app-icon-button hover:text-red-500 dark:hover:text-red-300 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 focus-visible:opacity-100"
        >
